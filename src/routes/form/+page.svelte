...
let brands = [
    ...
    {
        value: "Chief",
        url: "/images/chief.png"
    },
    {
        value: "Bellini",
        url: "/images/bellini.png"
    },
    {
        value: "Magnavox",
        url: "/images/magnavox.png"
    },
    {
        value: "Gardenglo",
        url: "/images/gardenglo.png"
    },
    {
        value: "Linda",
        url: "/images/linda.png"
    },
    {
        value: "Ringgrip",
        url: "/images/ringgrip.png"
    },
    {
        value: "Taller",
        url: "/images/taller.png"
    },
]
...
{:else}
    <div class="page">
        <form>
            ...
            <div class="inputs-group">
                <h3>Select brand purchased</h3>
                {#if $v.fields.brandPurchased.hasError}
                    <p class="error">Please select the product brand purchased</p>
                {/if}
                <div class="brand-select">
                    <ImageSelector
                        v={$v.fields.brandPurchased}
                        images={brands}
                        bind:value={customer.brandPurchased}/>
                </div>
            </div>
            <div class="inputs-group">
